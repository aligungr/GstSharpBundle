...
namespace GLib {
	...
	public class Signal {
		...
		void ClosureDisposedCB(object o, System.EventArgs args) {
			if (o == before_closure) {
				before_closure.Disposed -= new System.EventHandler(ClosureDisposedHandler);
				before_closure.Invoked -= new ClosureInvokedHandler(ClosureInvokedCB);
				before_closure = null;
				before_handler = null;
			} else if (o == after_closure) {
				after_closure.Disposed -= new System.EventHandler(ClosureDisposedHandler);
		...
		System.EventHandler closure_disposed_cb;
		System.EventHandler ClosureDisposedHandler {
			get {
				if (closure_disposed_cb == null)
					closure_disposed_cb = new System.EventHandler(ClosureDisposedCB);
